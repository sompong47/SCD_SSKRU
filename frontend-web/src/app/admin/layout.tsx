    ...
    <div className="flex min-h-screen bg-gray-50">
      ...
      <aside className="w-64 bg-white shadow-lg flex flex-col hidden md:flex">
        ...
        <nav className="flex-1 px-4 py-6 space-y-2">
          ...
          <div className="pt-4 pb-2">
            <p className="text-xs font-semibold text-gray-400 uppercase tracking-wider">จัดการระบบข่าวสาร</p>
          </div>

          <Link 
            href="/admin/news" 
            className={`flex items-center gap-3 px-4 py-3 rounded-lg transition-colors ${isActive('/admin/news') ? 'bg-[#D4AF37] text-white shadow-md' : 'text-gray-600 hover:bg-gray-100'}`}
          >
            ...
            เพิ่มข่าว & จัดการ SDG
          </Link>
          <Link 
            href="/admin/sdg-rating" 
            className={`flex items-center gap-3 px-4 py-3 rounded-lg transition-colors ${isActive('/admin/sdg-rating') ? 'bg-[#D4AF37] text-white shadow-md' : 'text-gray-600 hover:bg-gray-100'}`}
          >
            {/* ไอคอนรูปดาว */}
